...
set(__CMAKE_TARGET_ID_PYTHON_MODULE__ 9)
...
macro(target_type TYPE)
  ...
  elseif ("${TYPE}" STREQUAL "PYTHON_MODULE")
    find_package(pybind11 CONFIG REQUIRED)
    add_definitions(-D__XTD_CURRENT_TARGET_ID__=${__CMAKE_TARGET_ID_PYTHON_MODULE__})
    pybind11_add_module(${TARGET_NAME} ${ALL_FILES})
    set(PROJECT_TYPE_REFERENCE xtd)
  else ()
    add_definitions(-D__XTD_CURRENT_TARGET_ID__=${__CMAKE_TARGET_ID_UNKNOWN__})
    message(FATAL_ERROR "the TYPE must be on of theses value : CONSOLE_APPLICATION, GUI_APPLICATION, TEST_APPLICATION, MODULE_LIBRARY, SHARED_LIBRARY, STATIC_LIBRARY, CUSTOM_TARGET, or PYTHON_MODULE.")
  endif ()
  ...
  if ("${TYPE}" STREQUAL "INTERFACE_LIBRARY")
    ...
    target_link_libraries(${TARGET_NAME} PUBLIC ${PROJECT_ALL_REFERENCES})
  endif ()
